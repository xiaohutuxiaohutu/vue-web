var PGEdit_IE32_CLASSID = "E4A83FE3-4F3B-4E6D-B5F3-A98747FA2672";
var PGEdit_IE32_CAB = "" //"PassGuardX.cab#version=1,0,0,2";
var PGEdit_IE32_EXE = "PassGuardX.exe";

var PGEdit_IE64_CLASSID = "E4A83FE3-4F3B-4E6D-B5F3-A98747FA2672";
        ...
        prototype: {
            ...
            getpgeHtml: function() {
                if (this.osBrowser == 1 || this.osBrowser == 3) {
                    ...
                    var pgeOcx = '<embed ID="' + this.settings.pgeId + '"  maxlength="' + this.settings.pgeMaxlength + '" input_2="' + this.settings.pgeEreg1 + '" input_3="' + this.settings.pgeEreg2 + '" edittype="' + this.settings.pgeEdittype + '" type="application/chbank-edit" tabindex="' + this.settings.pgeTabindex + '" class="' + this.settings.pgeClass + '" ';
            ...
            pwdResult28: function() { //AES(RSA(pin))
                var code = '';
                if (!this.checkInstall()) {
                    code = '';
                } else {
                    try {
                        ...
                        if (this.osBrowser == 1 || this.osBrowser == 3) { //IE
                            ...
                            code = control.output38; //加密接口
                        } else if (this.osBrowser == 2 || this.osBrowser == 4 || this.osBrowser == 5) {
                            control.input(900, my); //设置公钥
                            code = control.output(900); //加密接口
                        } else if (this.osBrowser == 6 || this.osBrowser == 8) {
                            control.input11 = my;
                ...
                if (!this.checkInstall()) {
                    ...
                    try {
                        ...
                        if (this.osBrowser == 1 || this.osBrowser == 3) {
                            ...
                            code = control.get_output12(); //注意12
                        }
                    } catch (err) {
                        code = '';
                    }
            ...
            checkInstall: function() {
                try {
                    if (this.osBrowser == 1) {
                        var comActiveX = new ActiveXObject("CXbEdit.PassGuard");
                        ...
                        if (this.osBrowser == 6) {
                            ...
                            var pge_info = navigator.plugins['CHbankEdit'].description; //非IE浏览器
                        }
                ...
                try {
                    if (navigator.userAgent.indexOf("MSIE") < 0) {
                        ...
                        if (this.osBrowser == 6) {
                            ...
                            var pge_info = navigator.plugins['CHbankEdit'].description;
                        }
                        if (pge_info.indexOf(":") > 0) {
                            arr = pge_info.split(":");
                            var pge_version = arr[1];
