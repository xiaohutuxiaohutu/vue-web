  ...
  <el-form class="formEmbedTable" ref="form" :model="form" :rules="rules" >
      ...
      <table class="printArea">
        ...
        <tr>
          ...
          <td>
            <el-form-item>
            <span v-if="form.isOrderType =='0' ">{{$tools.utils.formatDate(form.DEALTIME,{"symbol":"YYYY-MM-DD"})}} &nbsp;{{form.time}}</span>
            </el-form-item>
          </td>
        </tr>
         <tr>
...
<script>
export default {
  name: 'intelligentTransferDetail',
  components:{
	    	 ...
	    	 _this.$tools.request(_this,"CB020111.do",body).then(
	    				data=>{
			    			...
			    			if(errorCode =='0'){
			    				 ...
			    				 _this.form.isOrder=transferList[0].isOrder
			    				 
			    				 if( _this.form.isOrder=='1'){
			    					_this.form.isOrderType='0'
			    				 }
