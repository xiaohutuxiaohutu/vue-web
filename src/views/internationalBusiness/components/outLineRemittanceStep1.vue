  ...
  <div class="intraBankRemittanceStep1">
    ...
    <el-form ref="form" :model="form" :rules="rules" class="formEmbedTable mt20" target="iframe" enctype="multipart/form-data" method="post" id="internationTable">
          ...
          <td>
            <el-form-item prop="undertakingWay">
              <el-select placeholder="----请选择----" v-model="form.undertakingWay" @change="changeUndertakingWay">
                <el-option label="汇款人OUR" value="0"></el-option>
                <el-option label="收款人BEN" value="1"></el-option>
                <el-option label="共同SHA" value="2"></el-option>
              </el-select>
            </el-form-item>
      ...
      <table>
        ...
        <tr>
          <td rowspan="3"><span class="cRed">*</span>收款人名称及地址：</td>
          <td colspan="3">
            <span><span class="cRed">*</span>收款人名称</span>
            ...
            <el-tooltip effect="light" placement="right">
              ...
              <p>第一行及第二行：收款人名称 （如：ABCDEFG COMPANY LIMITED）；</p>
              <p>第三行：收款人地址 （如：1235 APPLE STREET）；</p>
              <p>第四行：收款人所在国家及邮政编码 （如：NEW YORK USA）；</p>
              </div>
              <span class="cOrange"><i class="el-icon-question"/></span>
            </el-tooltip>
          </td>
        ...
        <tr>
          ...
          <td colspan="3">
            <a class="cOrange" @click="selectSwiftClick(1)">Swift代码查询</a>
            <el-tooltip class="ml10" effect="light" placement="right">
              <div slot="content" style="width:400px;">
              <p>请填写收款银行之代理行SWIFT CODE，若无则请填写收款银行之代理行名称及地址；</p>
              <p>第一行及第二行：代理行名称 （如：MEMBERS UNITED BRIDGE CORPORATE FEDERAL CREDIT UNION）；</p>
              <p>第三行：代理行地址 （如：4450 WEAVER PARKWAY,WARRENVILLE）；</p>
              <p>第四行：代理行所在国家及邮政编码 （如：IL 60555 USA）；</p>
              </div>
              <span class="cOrange"><i class="el-icon-question"/></span>
            </el-tooltip>
          </td>
        ...
        <tr>
          <td colspan="3" class="tableEvenText">
            ...
            <el-form-item class="w400" prop="swiftCode1">
              <el-input v-model="form.swiftCode1" placeholder="请输入Swift Code"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span>代理行名称</span>
            <el-form-item class="w400" prop="agncBankName">
              <el-input v-model="form.agncBankName" placeholder="请输入名称"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span>代理行地址</span>
            <el-form-item class="w400" prop="agncBankAddress">
              <el-input v-model="form.agncBankAddress" placeholder="请输入地址"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span>代理行所在国家及邮政编码</span>
            <el-form-item class="w400" prop="agncCountryCode">
              <el-input v-model="form.agncCountryCode" placeholder="国家名-邮政编码"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td>收款人开户行在其代理行账号：</td>
          <td colspan="3">
            <el-form-item prop="depositOfAgncBankAccoun">
              <el-input v-model="form.depositOfAgncBankAccoun" placeholder="收款人账号"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td rowspan="5">
            <span class="cRed">*</span>收款人开户银行名称及地址：
          </td>
          <td colspan="3">
            <a class="cOrange" @click="selectSwiftClick(2)">Swift代码查询</a>
            <el-tooltip class="ml10" effect="light" placement="right">
              <div slot="content" style="width:400px;">
              <p>请填写收款人开户银行SWIFT CODE，若无则请填写收款人开户银行名称及地址；</p>
              <p>第一行及第二行：收款人开户银行名称 （如：MEMBERS UNITED BRIDGE CORPORATE FEDERAL CREDIT UNION）；</p>
              <p>第三行：收款人开户银行地址 （如：4450 WEAVER PARKWAY,WARRENVILLE）；</p>
              <p>第四行：收款人开户银行所在国家及邮政编码 （如：IL 60555 USA）；</p>
              </div>
              <span class="cOrange"><i class="el-icon-question"/></span>
            </el-tooltip>
          </td>
        ...
        <tr>
          <td colspan="3" class="tableEvenText">
            <span><span class="cRed">*</span>Swift Code</span>
            <el-form-item class="w400" prop="swiftCode2">
              <el-input v-model="form.swiftCode2" placeholder="请输入Swift Code"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span><span class="cRed">*</span>收款人开户银行名称</span>
            <el-form-item class="w400" prop="depositOfBankName">
              <el-input v-model="form.depositOfBankName" placeholder="请输入名称"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span><span class="cRed">*</span>收款人开户银行地址</span>
            <el-form-item class="w400" prop="depositOfBankAddress">
              <el-input v-model="form.depositOfBankAddress" placeholder="请输入地址"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="tableEvenText">
            <span><span class="cRed">*</span>收款人开户银行所在国家及邮政编码</span>
            <el-form-item class="w400" prop="depositCountryCode">
              <el-input v-model="form.depositCountryCode" placeholder="国家名-邮政编码"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
        ...
        <p align="center">
          <el-form-item ref="isAgree" prop="isAgree">
            <el-checkbox-group v-model="form.isAgree" @change="isAgreeCheckboxChage">
              <el-checkbox label="1">
                <span>同意<a class="cBlue" @click="dialogVisible6 = true">《汇款须知》</a></span>
              </el-checkbox>
            </el-checkbox-group>
          </el-form-item>
        </p>
    ...
    <div v-if="dialogVisible2">
      <SelectAccount @selectAccount1="selectAccount1" @saveAccountBak="saveAccountBak" remitType="1"></SelectAccount>
    </div>
    <!-- 收款人账号end -->
    <!--牌价查询-->
    ...
    <!--牌价查询end-->
    <!-- 选择开户银行 -->
    <div v-if="dialogVisible5">
      <selectSwift @selectSwift="selectSwift"></selectSwift>
    </div>
    <!-- 选择开户银行end -->
    <!-- 汇款须知 -->
    <el-dialog :visible.sync="dialogVisible6" width="910px" :close-on-click-modal="false" :close-on-press-escape="false">
      ...
      <span slot="footer" class="el-dialog__footer btnArea">
        <el-button @click="dialogVisible6 = false">关闭</el-button>
      </span>
    </el-dialog>
    <!-- 汇款须知end -->
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      dialogVisible5: false, //开户银行弹窗
      dialogVisible6: false, //汇款须知弹窗
      form: {
        ...
        agncBankAddress: '',
        agncCountryCode: '',
        // agncBankNameAndAddress: '',
        swiftCode2: '',
        depositOfAgncBankAccoun: '',
        depositOfBankName: '',
        depositOfBankAddress: '',
        depositCountryCode: '',
        // depositOfBankNameAndAddress: '',
        payAccount:'',//扣费账号
      ...
      swiftClickNo:'',  //1为收款银行之代理行名称及地址，2为收款人开户银行名称及地址
      spotExAccList: [],
      purchasedExAccList: [],
      otherAccList: [],
      accInfoList: [],
      ...
      rules: {
        ...
        tranCode1: [
          { trigger: 'blur', validator: this.tran1Validator },
        ...
        tranCode2: [
          { trigger: 'blur', validator: this.tran2Validator },
        ...
        swiftCode1:[
          { trigger: 'blur', validator: this.agncBankValidator }
        ],
        agncBankName: [
          { trigger: 'blur', validator: this.agncBankValidator }
        ],
        ...
        agncCountryCode: [
          // { trigger: 'blur', validator: this.agncBankValidator },
          // { trigger: 'change', validator: this.agncCountryCodeValidator }
        ],
        depositOfAgncBankAccoun: [
          //{ trigger: 'blur', validator: this.agncBankValidator },
          { trigger: 'change', validator: this.$tools.validator.isAccNo }
        ...
        depositCountryCode: [
          // { trigger: 'blur', validator: this.depositCountryCodeValidator },
          { trigger: 'change', message:"请输入",required:true }
        ],
        fileName: [
  ...
  methods: {
    ...
    resetForm() {
      ...
      _this.form.swiftCode1=""
      _this.form.agncBankName=""
      _this.form.agncBankAddress=""
      _this.form.agncCountryCode=""
      _this.form.depositOfAgncBankAccoun=""
      _this.form.swiftCode2=""
      _this.form.depositOfBankName=""
      _this.form.depositOfBankAddress=""
      _this.form.depositCountryCode=""
      _this.form.isSave=""
    },
    chineseRadioFN(val) {
      let _this = this
    ...
    tran1Validator(rule,value,callback){  //交易编码1
      let _this = this
      if(value=="" && (_this.form.tranCode1!="" || _this.form.transaction1!="" || _this.form.postscript1!="")){
        callback("请输入")
      }
      callback()
    },
    tranCode1Validator(rule, value, callback) {
      let _this = this
      if(value == "" || _this.form.tranCode1.length == 6){
    ...
    transaction1Validator(rule, value, callback) {
      let _this = this
      _this.isValiator1 = false
      if(_this.form.transAmount!="" && value != "" && (Number(_this.form.transaction1)+Number(_this.form.transaction2)) != Number(_this.form.transAmount)){
        _this.isValiator1 = true
        callback("交易编码对应金额之和应等于汇款金额，请重新输入！")
      }else if(_this.form.transAmount!="" && value != "" && (Number(_this.form.transaction1)+Number(_this.form.transaction2)) == Number(_this.form.transAmount)){
    ...
    tran2Validator(rule,value,callback){  //交易编码2
      let _this = this
      if(value=="" && (_this.form.tranCode2!="" || _this.form.transaction2!="" || _this.form.postscript2!="")){
        callback("请输入")
      }
      callback()
    },
    tranCode2Validator(rule, value, callback) {
      let _this = this
      if(value == "" || _this.form.tranCode2.length == 6){
        _this.$refs['transaction2'].validate("blur")
        callback()
      } else {
        callback("格式有误")
    ...
    transaction2Validator(rule, value, callback) {
      let _this = this
      _this.isValiator2 = false
      if(value != "" && (Number(_this.form.transaction1)+Number(_this.form.transaction2)) != Number(_this.form.transAmount)){
        _this.isValiator2 = true
        callback("交易编码对应金额之和应等于汇款金额，请重新输入！")
      }else if(value != "" && (Number(_this.form.transaction1)+Number(_this.form.transaction2)) == Number(_this.form.transAmount)){
    ...
    agncBankValidator(rule,value,callback){
      let _this = this
      if(value=="" && (_this.form.swiftCode1!=""||_this.form.agncBankName!=""||_this.form.agncBankAddress!=""||_this.form.depositOfAgncBankAccoun!=""||_this.form.agncCountryCode!="")){
        return callback("请输入")
      }
      callback()
    },
    agncCountryCodeValidator(rule, value, callback) {
      let _this = this
      if(_this.form.agncCountryCode.indexOf("-") <= 1){
        return callback("请填写,格式为‘国家名-邮政编码’")
      }else{
        let val1 = _this.form.agncCountryCode.split("-")[0]
        let val2 = _this.form.agncCountryCode.split("-")[1]
        if(_this.$tools.validator.isNumEng(val2) || $.trim(val1)=="" || $.trim(val2)=="") return callback("请填写,格式为‘国家名-邮政编码’")
        // if(_this.$tools.validator.isNumEng(val1.replace(/\s+/,"")) || _this.$tools.validator.isNumEng(val2) || $.trim(val1)=="" || $.trim(val2)=="") return callback("请填写,格式为‘国家名-邮政编码’")
        return callback()
      }
    },
    depositCountryCodeValidator(rule, value, callback) {
      let _this = this
      if(_this.form.depositCountryCode.indexOf("-") <= 1){
        return callback("请填写,格式为‘国家名-邮政编码’")
      }else{
        let val1 = _this.form.depositCountryCode.split("-")[0]
        let val2 = _this.form.depositCountryCode.split("-")[1]
        if(_this.$tools.validator.isNumEng(val2) || $.trim(val1)=="" || $.trim(val2)=="") return callback("请填写,格式为‘国家名-邮政编码’")
        callback()
      }
    },
    ...
    isAgreeValidator(rule,value,callback){
      let _this = this
      if(!value){
        if(_this.form.countryNameAndCode=='中华人民共和国/China-CHN') return callback('请同意《汇款须知》')
        else return callback('请同意《汇款须知》')
      }
      callback()
    },
    ...
    selectAccount1(val) {
      ...
      if (val != null && val != undefined && JSON.stringify(val)!='{}') {
        ...
        _this.form.recAccountBak = val.acctNo  //备份收款人账号
        _this.form.recName = val.acctNm
        _this.form.region = val.address
        _this.form.countryAndCode = val.country
        _this.form.swiftCode1 = val.swiftCode1
        _this.form.agncBankName = val.agncBankName
        _this.form.agncBankAddress = val.agncBankAddress
        _this.form.depositOfAgncBankAccoun = val.depositOfAgncBankAccoun
        _this.form.swiftCode2 = val.swiftCode2
        _this.form.depositOfBankName = val.depositOfBankName
        _this.form.depositOfBankAddress = val.depositOfBankAddress
      }
      _this.dialogVisible2 = false
    },
    selectSwiftClick(val){
      let _this = this
      _this.swiftClickNo = val
      _this.dialogVisible5 = true
    },
    selectSwift(val){
      let _this = this
      if (val != null && val != undefined && JSON.stringify(val)!='{}') {
        if(_this.swiftClickNo=='1'){
          _this.form.swiftCode1 = val.swiftNo
          _this.form.agncBankName = val.bankName
          _this.form.agncBankAddress = val.addre1+', '+val.addre2
          _this.form.agncCountryCode = val.country
        }else{
          _this.form.swiftCode2 = val.swiftNo
          _this.form.depositOfBankName = val.bankName
          _this.form.depositOfBankAddress = val.addre1+', '+val.addre2
          _this.form.depositCountryCode = val.country
        }
      }
  ...
  mounted() {
    ...
    _this.form.bsnCode = "CB050102"
    _this.form.cstName = _this.user.cstCN
    if(_this.user.cstCertType=='201'){
      _this.form.unitCode = _this.user.cstCertNo  //组织机构代码
