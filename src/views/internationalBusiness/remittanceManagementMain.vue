  ...
  <ynet-content id="templateName" class="main-content" :headerInformation="true" :headerMenu="true">
    ...
    <div class="functionalArea">
      ...
      <div class="p20">
        ...
        <!--进度条--end-->
        <intraBankRemittanceStep1 v-if="stepIndex=='0'" @changeStep="changeStep" @showFileTable="showFileTable" :formData1="formData1" :turnUpNums="turnUpNums" :isShowFileTable="isShowFileTable"></intraBankRemittanceStep1>
        <intraBankRemittanceStep2 v-if="stepIndex=='1' && formData.countryNameAndCode=='中华人民共和国/China-CHN'" @changeStep1="changeStep1" @showFileTable="showFileTable" :formData="formData" :formData1="formData1" :isVisiable="isVisiable" remitType='0'></intraBankRemittanceStep2>
        <outLineRemittanceStep2 v-if="stepIndex=='1' && formData.countryNameAndCode!='中华人民共和国/China-CHN'" @changeStep1="changeStep1" @showFileTable="showFileTable" :formData="formData" :formData1="formData1" :isVisiable="isVisiable" remitType='0'></outLineRemittanceStep2>
        <intraBankRemittanceStep3 v-if="stepIndex=='2'" @changeStep1="changeStep1" :formData="formData1"></intraBankRemittanceStep3>
      </div>
