                ...
                <li class="ul1li">
                  <ul class="ul2">
                    ...
                    <li><img src="../../../images/login/function_title_bj.png" alt="">
                      <span style="position:absolute;left:58px;top:79px;color:#FFF">安卓手机</span>
                    </li>
                    <li style="width:95px;height:95px;position: absolute;top: -8px;left: 97px;">
                      <img src="../../../images/login/saoMa_Android.png" style="width: auto;height: auto;max-width: 100%;max-height: 100%;"/>
                    </li>
                  </ul>
                </li>
                 <li class="ul1li">
                  <ul class="ul2">
                    ...
                    <!--li>下载客户端</li-->
                    <li><img src="../../../images/login/function_title_bj.png" alt="">
                      <span style="position:absolute;left:388px;top:79px;color:#FFF">苹果手机</span>
                    </li>
                    <li style="width:95px;height:95px;position: absolute;top: -8px;left: 422px;">
                      <img src="../../../images/login/saoMa_IOS.png" style="width: auto;height: auto;max-width: 100%;max-height: 100%;"/>
                    </li>
                  </ul>
                </li>
                    ...
                    <div class="receiptTable1">
                        <table>
                            ...
                            <tr> 
                                ...
                                <td class="w300 tal" v-else>0.00</td>
  ...
  data() {
    return {
      downItems: [
        ...
        { message: '手机银行(安卓版)', url:'/corpbank/static/androidDownload/chbank.apk' }
      ],
      sealType:'',
      downPath:'',
      first: true,
