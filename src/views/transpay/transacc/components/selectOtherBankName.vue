<template>
    <div class="importCreditOpen">
		 <el-form ref="form" :model="form" :rules="rules"  class="formEmbedTable">
		  ...
		  <div class="tableData hideSelectAll printArea selectTable">
			   ...
			   selectUnionBank(currentPage){
			      ...
			      toggleRowSelection(){
			    	  ...
			    	  if(_this.currentRow !=null){
			    		  ...
			    		  _this.selankPageNameMsg.payNode=_this.currentRow.bankNo
				    	  _this.$emit("goOtherBankPage","1",_this.selankPageNameMsg)
			    	  }else{
			    		  this.$alert('请勾选选列表数据', '提示', {
	    			              confirmButtonText: '确定'
	    			            });
			    	  }
...
<style>	
.selectTable{width:918px !important;}
</style>