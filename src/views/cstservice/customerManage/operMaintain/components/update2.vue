        ...
        <div class="mt30">
            <div class="tableData printArea">
                <el-table :data="tableData">
                    ...
                    <el-table-column label="操作权限" align="left" width="180">
                        <template scope="scope">
...
export default {
    ...
    methods: {
        ...
        nextStep() {
            ...
            for (var item of _this.accInfoList) {
                if (item.userAccRight) {
                    userAccRightAdd.push({ accNo: item.accNo, userAccRight: item.userAccRight, userNo: _this.formData.userNo })
                }
            }
                ...
                data => {
                    if (data.body.errorCode == 0) {
                        ...
                        if (_this.formData.userAccRightAdd) {
                            ...
                            for (var item1 of _this.accInfoList) {
                                for (var item2 of _this.formData.userAccRightList) {
                                    if (item1.accNo == item2.accNo) {
                                        item1.userAccRight = item2.userAccRight
                                    }
                                }
                            }
                        }
