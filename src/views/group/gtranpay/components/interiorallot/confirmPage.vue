<template>
  <div class="tableData ">
    <el-form class="form p20">
      ...
      <el-form-item label="转入子公司组别：">{{confirmMsg.transToGroup}}</el-form-item>

      <el-form-item label="转入子公司账号：">{{confirmMsg.transToAcctNum}}</el-form-item>

      <el-form-item label="转入子公司账户名：">{{confirmMsg.transToAcctName}}</el-form-item>

      <el-form-item label="存入金额：">{{confirmMsg.amount}}</el-form-item>
      ...
      <el-form-item label="转出子公司组别：">{{confirmMsg.transFromGroup}}</el-form-item>

      <el-form-item label="转出子公司账号：">{{confirmMsg.transFromAcctNum}}</el-form-item>

      <el-form-item label="转出子公司账户名：">{{confirmMsg.transFromAcctName}}</el-form-item>
