<template>
  <div class="fourForm tableForm mt20">
    <el-form class="mb30">
      <h3>付款信息</h3>
      <el-row >
        <el-form-item label="转出子公司分组：" class="fullLine">
          {{confirmMsg.payAcctGroupDesc}}
        </el-form-item>
      </el-row>
      <el-row>
    ...
    <!--<el-form >-->
      <el-row >
        <el-form-item label="转入子公司分组：" class="fullLine">
          {{confirmMsg.recAcctGroupDesc}}
        </el-form-item>
      </el-row>
      <el-row >
        <el-form-item label="转入子公司账号：" class="fullLine">
          {{confirmMsg.recAccount}}
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="转入子公司账户名：" class="fullLine">
          {{confirmMsg.recName}}
        </el-form-item>
      </el-row>
      <el-row>
...
export default {
  ...
  methods: {
    ...
    endSublmit(){
      ...
      _this.$tools.request(_this,"CB040206.do",_this.confirmMsg).then( data => {
        //下一步，交易结果页面
        ...
        if(errorCode == '0'){
          ...
          _this.$alert(errorMsg, errorCode, {
