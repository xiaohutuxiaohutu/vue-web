<template>
  <div class="tableData ">
    <el-form class="form p20">
      ...
      <el-form-item label="转入子公司组别：">{{confirmMsg.subGroup}}</el-form-item>

      <el-form-item label="转入子公司账号：">{{confirmMsg.subAcct}}</el-form-item>

      <el-form-item label="转入子公司账户名：">{{confirmMsg.subAcctName}}</el-form-item>
      ...
      <el-form-item label="转出母公司账号：">{{confirmMsg.subAcct}}</el-form-item>

      <el-form-item label="转出母公司账户名：">{{confirmMsg.subAcctName}}</el-form-item>
